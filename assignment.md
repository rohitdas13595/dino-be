...
3. Asset Types: Define the application assets (e.g., "Gold Coins", "Diamonds", "Loyalty
   Points").
4. System Accounts: Create at least one "System" wallet (e.g., a "Treasury" or "Revenue"
   account) to act as the source/destination for funds.
5. User Accounts: Create at least two users with initial balances.
